...
import { useCMS, useLocalForm, useGlobalForm, useForm } from 'tinacms';
...
export default function GlobalForms() {
  ...
  let content = {
    text:
      "There's a menu in the sidebar now, we can access global forms there.",
  };
...
// The rest of the page specific code & form structure remains the same as our previous examples`;
  ...
  return (
    <>
      ...
      <Code
        readMoreLink="https://tinacms.org/docs/forms#useglobalform"
