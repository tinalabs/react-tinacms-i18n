...
export default () => {
  const i18n = new I18nClient({
    ...
    locales: [
      ...
      { language: { code: 'fr', label: 'French' }, region: { code: "CA", label: "Canada" }, modifiers: ['NB'] },
      { language: { code: 'en', label: 'English' }, region: { code: "CA", label: "Canada" }, modifiers: ['PE'] },
      { language: { code: 'fr', label: 'French' }, region: { code: "FR", label: "France" } },
      { language: { code: 'en', label: 'English' }, region: { code: "FR", label: "France" } },
