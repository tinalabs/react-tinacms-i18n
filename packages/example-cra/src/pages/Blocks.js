    ...
    fields: [
      {
        ...
        description:
          'Blocks can be used edit structured content of mixed types. Each can be edited, reordered, or deleted.',
      },
    ],
...
return (
  ...
  return (
    <>
      ...
      <Code
        readMoreLink="https://tinacms.org/docs/fields/blocks"
